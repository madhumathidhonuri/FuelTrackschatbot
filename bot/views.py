    ...
    try:
        ...
        if has_telugu_script:
            ...
            system_prompt = (
                ...
                "*గడువు దాటకముందే మా సేల్స్ టీమ్‌ని సంప్రదించండి: +91 90006 66914.*\n"
        ...
        # ENGINE 2: TENGLISH
            ...
            system_prompt = (
                ...
                f"*Deadline mundu maa sales team ni contact cheyyandi: +91 90006 66914.*\n"
        ...
        # ENGINE 3: ENGLISH
            ...
            system_prompt = (
                ...
                "*Contact our sales team before the deadline: +91 90006 66914.*\n"
